...
export default named({
	...
	media: group(
		rule(".of-contain", { object_fit: "contain" }),
		rule(".of-cover", { object_fit: "cover" }),
		rule(".of-fill", { object_fit: "fill" }),
		rule(".of-none", { object_fit: "none" }),
		rule(".of-scale-down", { object_fit: "scale-down" }),
	),
