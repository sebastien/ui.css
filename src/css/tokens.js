	...
	tokens({
		...
		range: {
			...
			track: {
				size: "0.28em",
				radius: "999px",
				color: `${vars.input.normal.border.base}`,
			},
			thumb: {
				size: "0.95em",
				radius: "50%",
				background: `${vars.input.normal.background.base}`,
				border: {
					width: `${vars.input.normal.border.width}`,
					style: `${vars.input.normal.border.style}`,
					color: `${vars.input.normal.border.base}`,
				},
			},
			normal: {
		...
		checkbox: {
			...
			normal: {
				border: {
					base: `${vars.input.normal.border.base}`,
					tint: `${vars.input.normal.border.tint}`,
					blend: `${vars.input.normal.border.blend}`,
					opacity: `${vars.input.normal.border.opacity}`,
					width: `${vars.input.normal.border.width}`,
					style: `${vars.input.normal.border.style}`,
				},
				text: {
				...
				background: {
					base: `${vars.input.normal.background.base}`,
					tint: `${vars.input.normal.background.tint}`,
					blend: `${vars.input.normal.background.blend}`,
					opacity: `${vars.input.normal.background.opacity}`,
				},
				outline: {
					base: `${vars.input.normal.outline.base}`,
					tint: `${vars.input.normal.outline.tint}`,
					blend: `${vars.input.normal.outline.blend}`,
					opacity: `${vars.input.normal.outline.opacity}`,
					width: `${vars.input.normal.outline.width}`,
					style: `${vars.input.normal.outline.style}`,
				},
			},
			hover: {
				border: {
					base: `${vars.input.hover.border.base}`,
					tint: `${vars.input.hover.border.tint}`,
					blend: `${vars.input.hover.border.blend}`,
					opacity: `${vars.input.hover.border.opacity}`,
					width: `${vars.input.hover.border.width}`,
					style: `${vars.input.hover.border.style}`,
				},
				background: {
					base: `${vars.input.hover.background.base}`,
					tint: `${vars.input.hover.background.tint}`,
					blend: `${vars.input.hover.background.blend}`,
					opacity: `${vars.input.hover.background.opacity}`,
				},
				outline: {
					base: `${vars.input.hover.outline.base}`,
					tint: `${vars.input.hover.outline.tint}`,
					blend: `${vars.input.hover.outline.blend}`,
					opacity: `${vars.input.hover.outline.opacity}`,
					width: `${vars.input.hover.outline.width}`,
					style: `${vars.input.hover.outline.style}`,
				},
			},
			focus: {
				background: {
					base: `${vars.input.focus.background.base}`,
					tint: `${vars.input.focus.background.tint}`,
					blend: `${vars.input.focus.background.blend}`,
					opacity: `${vars.input.focus.background.opacity}`,
				},
				border: {
					base: `${vars.input.focus.border.base}`,
					tint: `${vars.input.focus.border.tint}`,
					blend: `${vars.input.focus.border.blend}`,
					opacity: `${vars.input.focus.border.opacity}`,
					width: `${vars.input.focus.border.width}`,
					style: `${vars.input.focus.border.style}`,
				},
				outline: {
					base: `${vars.input.focus.outline.base}`,
					tint: `${vars.input.focus.outline.tint}`,
					blend: `${vars.input.focus.outline.blend}`,
					opacity: `${vars.input.focus.outline.opacity}`,
					width: `${vars.input.focus.outline.width}`,
					style: `${vars.input.focus.outline.style}`,
				},
			},
			active: {
				border: {
					base: `${vars.input.active.border.base}`,
					tint: `${vars.input.active.border.tint}`,
					blend: `${vars.input.active.border.blend}`,
					opacity: `${vars.input.active.border.opacity}`,
					width: `${vars.input.active.border.width}`,
					style: `${vars.input.active.border.style}`,
				},
				background: {
					base: `${vars.input.active.background.base}`,
					tint: `${vars.input.active.background.tint}`,
					blend: `${vars.input.active.background.blend}`,
					opacity: `${vars.input.active.background.opacity}`,
				},
				outline: {
					base: `${vars.input.active.outline.base}`,
					tint: `${vars.input.active.outline.tint}`,
					blend: `${vars.input.active.outline.blend}`,
					opacity: `${vars.input.active.outline.opacity}`,
					width: `${vars.input.active.outline.width}`,
					style: `${vars.input.active.outline.style}`,
				},
			},
			selected: {
				background: {
					base: `${vars.input.selected.background.base}`,
					tint: `${vars.input.selected.background.tint}`,
					blend: `${vars.input.selected.background.blend}`,
					opacity: `${vars.input.selected.background.opacity}`,
				},
			},
			disabled: {
				background: {
					base: `${vars.input.disabled.background.base}`,
					tint: `${vars.input.disabled.background.tint}`,
					blend: `${vars.input.disabled.background.blend}`,
					opacity: `${vars.input.disabled.background.opacity}`,
				},
				border: {
					base: `${vars.input.disabled.border.base}`,
					tint: `${vars.input.disabled.border.tint}`,
					blend: `${vars.input.disabled.border.blend}`,
					opacity: `${vars.input.disabled.border.opacity}`,
					width: `${vars.input.disabled.border.width}`,
					style: `${vars.input.disabled.border.style}`,
				},
				outline: {
					base: `${vars.input.disabled.outline.base}`,
					tint: `${vars.input.disabled.outline.tint}`,
					blend: `${vars.input.disabled.outline.blend}`,
					opacity: `${vars.input.disabled.outline.opacity}`,
					width: `${vars.input.disabled.outline.width}`,
					style: `${vars.input.disabled.outline.style}`,
				},
				text: {
					base: `${vars.color.neutral}`,
					tint: `${vars.color.ink}`,
